...
import badstudent.mappings.云南.云南Mappings;
import badstudent.mappings.内蒙古.内蒙古Mappings;
import badstudent.mappings.北京.北京Mappings;
import badstudent.mappings.台湾.台湾Mappings;
import badstudent.mappings.吉林.吉林Mappings;
import badstudent.mappings.四川.四川Mappings;
import badstudent.mappings.天津.天津Mappings;
import badstudent.mappings.宁夏.宁夏Mappings;
import badstudent.mappings.安徽.安徽Mappings;
import badstudent.mappings.山东.山东Mappings;
import badstudent.mappings.山西.山西Mappings;
import badstudent.mappings.广东.广东Mappings;
import badstudent.mappings.广西.广西Mappings;
import badstudent.mappings.新疆.新疆Mappings;
import badstudent.mappings.江苏.江苏Mappings;
import badstudent.mappings.江西.江西Mappings;
import badstudent.mappings.河北.河北Mappings;
import badstudent.mappings.河南.河南Mappings;
import badstudent.mappings.浙江.浙江Mappings;
import badstudent.mappings.海南.海南Mappings;
import badstudent.mappings.湖北.湖北Mappings;
import badstudent.mappings.湖南.湖南Mappings;
import badstudent.mappings.澳门.澳门Mappings;
import badstudent.mappings.甘肃.甘肃Mappings;
import badstudent.mappings.福建.福建Mappings;
import badstudent.mappings.西藏.西藏Mappings;
import badstudent.mappings.贵州.贵州Mappings;
import badstudent.mappings.辽宁.辽宁Mappings;
import badstudent.mappings.重庆.重庆Mappings;
import badstudent.mappings.陕西.陕西Mappings;
import badstudent.mappings.青海.青海Mappings;
import badstudent.mappings.香港.香港Mappings;
import badstudent.mappings.黑龙江.黑龙江Mappings;
