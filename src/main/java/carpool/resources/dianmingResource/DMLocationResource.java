...
public class DMLocationResource extends ServerResource{

	//passes received json into message
		//note that this parseJSON 
		private Location parseJSON(Representation entity){
			...
			if (goOn && entity!= null && entity.getSize() < Constants.max_userLength){
		        ...
		        if (newLocation != null){
		        	if (Location.isLocationVaild(newLocation)){
			            ...
			            newLocation = DMMessageDaoService.updateLocation(newLocation, messageId ,id);
			            if (newLocation != null){
