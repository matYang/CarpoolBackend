...
public class HistoryListTest {
	...
	private DMMessage default3 = new DMMessage(1,2,"ImgPath2","Name3",30,40,"phone3","email3","qq2",Constants.paymentMethod.all,
			new Location("a2 a2 a2 a2"),calender,calender,"note2",Constants.messageType.help,Constants.gender.both,
			Constants.messageState.deleted,50,true,false,new ArrayList<Transaction>(),calender);
	private DMMessage default4 = new DMMessage(1,2,"ImgPath2","Name4",30,40,"phone4","email4","qq2",Constants.paymentMethod.all,
			new Location("a2 a2 a2 a2"),calender,calender,"note2",Constants.messageType.help,Constants.gender.both,
			Constants.messageState.deleted,50,true,false,new ArrayList<Transaction>(),calender);
